...
export const translations: Record<Language, Translations> = {
  'zh-TW': {
    ...
    page: {
      ...
      navFeatures: '特色',
      navSolutions: '主要功能',
      heroTitlePart1: 'HongLou WiseRead',
      heroTitleHighlight: '《紅樓夢》',
      heroTitlePart2: '閱讀學習系統',
      heroSubtitle: '借助 AI 賦能的文本分析、學習狀況洞察與深度研究工具，開啟您的智慧閱讀之旅。',
      ...
      // Navigation & Buttons
      navLogin: '登入',
      navStartExplore: '開始探索',
      btnStartLearning: '立即開始學習',
      btnLearnMore: '了解更多功能',
      btnExplore: '立即探索',
      btnFreeStart: '免費開始學習',
      btnExploreCommunity: '探索學習社群',
      // Features Section
      featuresTitle: '核心功能特色',
      featuresSubtitle: '結合傳統文學與現代科技，為您打造前所未有的經典閱讀體驗',
      feature1Title: 'AI 智能分析',
      feature1Desc: '運用先進AI技術，深度解析文本含義、人物性格與情節發展',
      feature2Title: '人物關係圖譜',
      feature2Desc: '互動式人物關係圖，清晰呈現複雜的人物脈絡與情感糾葛',
      feature3Title: '智能註解系統',
      feature3Desc: '逐句詳細註解，文言文白話對照，降低閱讀理解門檻',
      feature4Title: '學習社群交流',
      feature4Desc: '與同好分享心得，參與討論，在交流中加深理解',
      feature5Title: '學習進度追蹤',
      feature5Desc: '個人化學習儀表板，追蹤閱讀進度與理解深度',
      feature6Title: '詩詞意境探索',
      feature6Desc: '深入品味作品中的詩詞歌賦，感受古典文學之美',
      // Content Preview Section
      contentPreviewTitle: '探索學習內容',
      contentPreviewSubtitle: '從人物到情節，從詩詞到文化，全方位深度學習紅樓夢',
      preview1Title: '人物花園',
      preview1Subtitle: '探索紅樓人物世界',
      preview1Desc: '在虛擬園林中邂逅林黛玉、賈寶玉等經典人物，了解他們的性格特點與人生軌跡',
      preview1Badge: '人物關係',
      preview2Title: '章節導覽',
      preview2Subtitle: '120回經典重現',
      preview2Desc: '跟隨故事脈絡，體驗從繁華到衰落的人生百態，感受曹雪芹筆下的世情冷暖',
      preview2Badge: '故事情節',
      preview3Title: '詩詞賞析',
      preview3Subtitle: '古典文學精華',
      preview3Desc: '品味紅樓夢中的詩詞歌賦，從文學角度深度理解人物內心與時代背景',
      preview3Badge: '詩詞文學',
      // Statistics Section
      statsTitle: '學習成果展現',
      statsSubtitle: '與千名學習者一同探索經典文學的魅力',
      stat1Number: '1,200+',
      stat1Label: '活躍學習者',
      stat2Number: '120',
      stat2Label: '詳細章節解析',
  ...
  'zh-CN': {
    ...
    page: {
      ...
      navSolutions: '主要功能',
      heroTitlePart1: 'HongLou WiseRead',
      heroTitleHighlight: '《红楼梦》',
      heroTitlePart2: '阅读学习系统',
      heroSubtitle: '借助 AI 赋能的文本分析、学习状况洞察与深度研究工具，开启您的智慧阅读之旅。',
      ...
      // Navigation & Buttons
      navLogin: '登入',
      navStartExplore: '开始探索',
      btnStartLearning: '立即开始学习',
      btnLearnMore: '了解更多功能',
      btnExplore: '立即探索',
      btnFreeStart: '免费开始学习',
      btnExploreCommunity: '探索学习社群',
      // Features Section
      featuresTitle: '核心功能特色',
      featuresSubtitle: '结合传统文学与现代科技，为您打造前所未有的经典阅读体验',
      feature1Title: 'AI 智能分析',
      feature1Desc: '运用先进AI技术，深度解析文本含义、人物性格与情节发展',
      feature2Title: '人物关系图谱',
      feature2Desc: '互动式人物关系图，清晰呈现复杂的人物脉络与情感纠葛',
      feature3Title: '智能注解系统',
      feature3Desc: '逐句详细注解，文言文白话对照，降低阅读理解门槛',
      feature4Title: '学习社群交流',
      feature4Desc: '与同好分享心得，参与讨论，在交流中加深理解',
      feature5Title: '学习进度追踪',
      feature5Desc: '个人化学习仪表板，追踪阅读进度与理解深度',
      feature6Title: '诗词意境探索',
      feature6Desc: '深入品味作品中的诗词歌赋，感受古典文学之美',
      // Content Preview Section
      contentPreviewTitle: '探索学习内容',
      contentPreviewSubtitle: '从人物到情节，从诗词到文化，全方位深度学习红楼梦',
      preview1Title: '人物花园',
      preview1Subtitle: '探索红楼人物世界',
      preview1Desc: '在虚拟园林中邂逅林黛玉、贾宝玉等经典人物，了解他们的性格特点与人生轨迹',
      preview1Badge: '人物关系',
      preview2Title: '章节导览',
      preview2Subtitle: '120回经典重现',
      preview2Desc: '跟随故事脉络，体验从繁华到衰落的人生百态，感受曹雪芹笔下的世情冷暖',
      preview2Badge: '故事情节',
      preview3Title: '诗词赏析',
      preview3Subtitle: '古典文学精华',
      preview3Desc: '品味红楼梦中的诗词歌赋，从文学角度深度理解人物内心与时代背景',
      preview3Badge: '诗词文学',
      // Statistics Section
      statsTitle: '学习成果展现',
      statsSubtitle: '与千名学习者一同探索经典文学的魅力',
      stat1Number: '1,200+',
      stat1Label: '活跃学习者',
      stat2Number: '120',
      stat2Label: '详细章节解析',
      ...
      stat4Label: '学习完成率',
      // CTA Section
      ctaTitle: '开启您的红楼梦学习之旅',
      ctaSubtitle: '加入我们的学习社群，与志同道合的朋友一起深入探索中国古典文学的瑰宝。无论您是初学者还是资深爱好者，都能在这里找到适合的学习内容。',
      ctaStats: '已有超过 1,200 名学习者选择了我们的平台',
      // Footer
      footerSlogan: '致力于传承中华古典文学',
      footerRights: '© 2024 红楼慧读平台. 致力于传承中华古典文学.',
    },
    appShell: {
      userAccount: '我的账户',
      settings: '设置',
  ...
  'en-US': {
    ...
    page: {
      ...
      heroTitlePart1: 'HongLou WiseRead',
      heroTitleHighlight: 'Dream of the Red Chamber',
      heroTitlePart2: ' Reading Learning System',
      ...
      // Navigation & Buttons
      navLogin: 'Login',
      navStartExplore: 'Start Exploring',
      btnStartLearning: 'Start Learning Now',
      btnLearnMore: 'Learn More',
      btnExplore: 'Explore Now',
      btnFreeStart: 'Start Learning for Free',
      btnExploreCommunity: 'Explore Learning Community',
      // Features Section
      featuresTitle: 'Core Features',
      featuresSubtitle: 'Combining traditional literature with modern technology to create an unprecedented classic reading experience',
      feature1Title: 'AI Intelligent Analysis',
      feature1Desc: 'Utilizing advanced AI technology to deeply analyze text meaning, character personalities, and plot development',
      feature2Title: 'Character Relationship Map',
      feature2Desc: 'Interactive character relationship diagram clearly presenting complex character relationships and emotional entanglements',
      feature3Title: 'Intelligent Annotation System',
      feature3Desc: 'Sentence-by-sentence detailed annotations with classical Chinese to vernacular comparison, lowering reading comprehension barriers',
      feature4Title: 'Learning Community Exchange',
      feature4Desc: 'Share insights with fellow enthusiasts, participate in discussions, and deepen understanding through exchange',
      feature5Title: 'Learning Progress Tracking',
      feature5Desc: 'Personalized learning dashboard tracking reading progress and understanding depth',
      feature6Title: 'Poetry Appreciation',
      feature6Desc: 'Deeply appreciate the poetry and lyrics in the work, feeling the beauty of classical literature',
      // Content Preview Section
      contentPreviewTitle: 'Explore Learning Content',
      contentPreviewSubtitle: 'From characters to plot, from poetry to culture, comprehensive in-depth learning of Dream of the Red Chamber',
      preview1Title: 'Character Garden',
      preview1Subtitle: 'Explore Red Chamber Characters',
      preview1Desc: 'Encounter classic characters like Lin Daiyu and Jia Baoyu in a virtual garden, understanding their personalities and life trajectories',
      preview1Badge: 'Character Relationships',
      preview2Title: 'Chapter Navigation',
      preview2Subtitle: '120 Chapters Revisited',
      preview2Desc: 'Follow the story arc, experiencing the vicissitudes of life from prosperity to decline, feeling the warmth and coldness under Cao Xueqin\'s pen',
      preview2Badge: 'Story Plot',
      preview3Title: 'Poetry Appreciation',
      preview3Subtitle: 'Classical Literature Essence',
      preview3Desc: 'Savor the poetry in Dream of the Red Chamber, deeply understanding characters\' inner worlds and historical context from a literary perspective',
      preview3Badge: 'Poetry & Literature',
      // Statistics Section
      statsTitle: 'Learning Achievements',
      statsSubtitle: 'Explore the charm of classical literature together with thousands of learners',
      stat1Number: '1,200+',
      stat1Label: 'Active Learners',
      stat2Number: '120',
      stat2Label: 'Detailed Chapter Analysis',
      stat3Number: '400+',
      stat3Label: 'In-depth Character Studies',
      stat4Number: '85%',
      stat4Label: 'Completion Rate',
      // CTA Section
      ctaTitle: 'Begin Your Dream of the Red Chamber Learning Journey',
      ctaSubtitle: 'Join our learning community and deeply explore the treasures of Chinese classical literature with like-minded friends. Whether you\'re a beginner or a seasoned enthusiast, you\'ll find suitable learning content here.',
      ctaStats: 'Over 1,200 learners have already chosen our platform',
      // Footer
      footerSlogan: 'Dedicated to preserving Chinese classical literature',
      footerRights: '© 2025 HoungLou WiseRead Platform. Dedicated to preserving Chinese classical literature.',
    },
    appShell: {
