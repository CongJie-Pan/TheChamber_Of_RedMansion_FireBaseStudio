...
古典文學閱讀市場呈現多元化的解決方案格局，現有競爭者可分為三大類別(參下頁之下表)：
...
AI 功能採用雙模型策略：Perplexity Sonar API 負責問答任務，其網路搜尋能力可整合學術研究成果提供具引用來源的回答；OpenAI GPT-4o-mini 負責評分批改，穩定的結構化輸出適合教育評量場景。知識圖譜則運用 D3.js 力導向演算法，將章回人物關係轉化為可互動探索的視覺化網絡。
